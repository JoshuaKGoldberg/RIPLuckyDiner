module.exports = function (grunt) {
    grunt.initConfig({
        ...
        "zip": {
            "dist": {
                "cwd": "<%= meta.paths.dist %>/RipLuckyDiner-<%= pkg.version %>/",
                "src": "<%= meta.paths.dist %>/RipLuckyDiner-<%= pkg.version %>/**",
                "dest": "<%= meta.paths.dist %>/RipLuckyDiner-<%= pkg.version %>.zip"
            }
        }
    });
    ...
    grunt.registerTask("default", [
        "clean", "tslint", "typescript", "copy", "uglify", "cssmin", "preprocess", "processhtml", "htmlmin", "zip"
    ]);
};